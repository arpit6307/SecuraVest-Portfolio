  ...
  return (
    <section id="contact" className="contact-section position-relative overflow-hidden">
            ...
            <Col lg={7}>
                <div className="form-glass-card p-4 p-md-5">
                    <form onSubmit={handleSubmit}>
                        ...
                        {/* Notifications */}
                        {status === 'success' && (
                            <div className="mt-3 p-3 rounded glass-success text-center animate-fade-in">
                                <FaCheckCircle className="me-2" /> Request Sent! I will contact you shortly.
                            </div>
                        )}
                        {status === 'error' && (
                            <div className="mt-3 p-3 rounded glass-error text-center animate-fade-in">
                                <FaExclamationCircle className="me-2" /> Connection Error. Please call directly.
                            </div>
                        )}
                    </form>
                </div>
      ...
      <style>{`
        ...
        /* Status Messages */
        .glass-success { background: rgba(40, 167, 69, 0.2); color: #28a745; border: 1px solid rgba(40, 167, 69, 0.3); }
        .glass-error { background: rgba(220, 53, 69, 0.2); color: #dc3545; border: 1px solid rgba(220, 53, 69, 0.3); }
